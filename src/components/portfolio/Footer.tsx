    ...
    <footer className="relative py-16 sm:py-20 lg:py-24 border-t border-border/30 overflow-hidden bg-gradient-to-b from-background to-background/95">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          viewport={{ once: true }}
          className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] sm:w-[800px] lg:w-[1000px] h-[300px] sm:h-[400px] lg:h-[500px] rounded-full bg-primary blur-[120px]"
        />
      </div>
            ...
            {socialLinks?.map((link, index) => {
              ...
              return (
                <motion.a
                  ...
                  className="w-11 h-11 rounded-xl bg-card/50 backdrop-blur-sm border border-border/50 flex items-center justify-center hover:border-primary/50 hover:bg-primary/10 transition-all duration-300 group"
                >
